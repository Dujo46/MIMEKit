...
open enum MIMEType: String, CaseIterable {
    ...
    case xml = "application/xml if not readable from casual users (RFC 3023, section 3)"
    case an = "text/xml if readable from casual users (RFC 3023, section 3)"
    case xul = "application/vnd.mozilla.xul+xml"
    case zip = "application/zip"
    case _3gp = "video/3gpp"
    case _3gp_withoutVideo = "audio/3gpp"
    case _3g2 = "video/3gpp2"
    case _3g2_withoutVideo = "audio/3gpp2"
